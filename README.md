...
<p>
  ...
  <h3 align="center">Pipefy Interface</h3>
  <p align="center">
    Re-creating pipefy interface with "drag 'n drop" functionality.
    <br />
    <a href="https://github.com/guiaramos/pipefy-interface.git"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/guiaramos/pipefy-interface.git">View Demo</a>
    ·
    <a href="https://github.com/guiaramos/pipefy-interface.git/issues">Report Bug</a>
    ·
    <a href="https://github.com/guiaramos/pipefy-interface.git/issues">Request Feature</a>
  </p>
</p>
</div>
...
The [Pipefy](https://www.pipefy.com) interface is known for having the most . The project is focused on the MERN stack, and the challenge is to build a web app and mobile app.
...
```sh
git clone https://github.com/guiaramos/pipefy-interface.git.git
```
